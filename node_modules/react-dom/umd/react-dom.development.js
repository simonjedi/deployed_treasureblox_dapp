  ...
  function checkClassInstance(workInProgress, ctor, newProps) {
...

    {
      ...
      if (typeof instance.componentWillreceiveProps === 'function') {
        error('%s has a method called ' + 'componentWillreceiveProps(). Did you mean componentWillReceiveProps()?', name);
      }

      if (typeof instance.UNSAFE_componentWillreceiveProps === 'function') {
        error('%s has a method called ' + 'UNSAFE_componentWillreceiveProps(). Did you mean UNSAFE_componentWillReceiveProps()?', name);
      }
